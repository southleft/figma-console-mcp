...
<Note>
**New in v1.14.0 — Cross-File Library Components:** `figma_get_library_components` discovers published components from shared design system files. Search by URL or file key, browse variants, and instantiate them in your working file — bridging the gap between multi-file design systems and AI-assisted design.
</Note>
