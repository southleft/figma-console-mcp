...
<Note>
**New in v1.7.0** — Design-code parity checker and component documentation generator. Compare Figma specs against your code, get actionable fix items, and generate platform-agnostic component docs from your design system.
</Note>
