...
description: "Connect AI to your design system. Extract tokens, debug plugins, and create designs programmatically."
---
...
Design systems aren't static documents—they're living interfaces that should be queryable, programmable, and always in sync.

Figma Console MCP bridges the gap between design tools and development workflows, giving AI assistants direct access to your Figma files for extraction, creation, and debugging.
...
<Columns cols={3}>
  ...
  <Card title="Create" icon="wand-magic-sparkles">
    Components and designs via the Plugin API
  </Card>
...
<Card title="Compare Modes" icon="code-compare" href="/MODE_COMPARISON">
...
<Columns cols={3}>
  <Card title="Use Cases" icon="lightbulb" href="/USE_CASES">
    Real scenarios for debugging, extraction, and implementation
  </Card>
