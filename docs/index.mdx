...
<Warning>
**Important:** Remote Mode is **read-only** with (((43 tools))). For design creation, development workflows, variable management, and full capabilities (57+ tools), use NPX Setup.
</Warning>
