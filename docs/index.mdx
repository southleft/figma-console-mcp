...
<Note>
**New in v1.13.0 — Design Linting:** `figma_lint_design` checks your designs for WCAG accessibility issues (contrast, text size, touch targets), hardcoded values, detached components, and layout quality — 10 rules, zero setup. Plus [Cloud Write Relay](/setup#-cloud-mode-web-ai-clients) for full design creation from Claude.ai, v0, Replit, and Lovable.
</Note>
