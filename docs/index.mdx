...
<Note>
**New in v1.18.0 — Design Annotations:** Read, write, and manage design annotations — the designer-authored specs for animation timings, interaction behaviors, and accessibility requirements. Annotations are automatically included in component documentation. 87+ tools total. [See what's new →](/figma-mcp-vs-figma-console-mcp)
</Note>
