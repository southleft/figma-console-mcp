...
<Note>
**New in v1.5** — Design System Health Dashboard with Lighthouse-style scoring, plus smart tab navigation that switches to existing tabs instead of duplicating them.
</Note>
