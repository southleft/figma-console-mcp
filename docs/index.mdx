...
<Note>
**New in v1.17.0 — AI Across All Figma Products:** Figma Console MCP now supports **FigJam boards** and **Figma Slides** alongside Figma Design files. Create stickies, flowcharts, and tables on whiteboards. Manage entire presentations — slides, transitions, and content. 24 new tools, 78+ total. [FigJam Guide →](/figjam) | [Slides Guide →](/slides)
</Note>
