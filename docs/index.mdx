...
<Note>
**New in v1.6.4** — Improved support for large design systems with batched page processing and extended timeouts. Plus clearer error messages for component instantiation.
</Note>
