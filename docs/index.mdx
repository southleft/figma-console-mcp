...
<Warning>
**Important:** Remote Mode is **read-only** with 18 tools. For design creation, development workflows, variable management, and full capabilities (53+ tools), use NPX Setup.
</Warning>
