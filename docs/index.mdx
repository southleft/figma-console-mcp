...
<Warning>
**Important:** Remote Mode is **read-only** with ((((44 tools)))). For design creation, development workflows, variable management, and full capabilities (58+ tools), use NPX Setup.
</Warning>
