...
<Warning>
**Important:** Remote Mode is **read-only** with 16 tools. For design creation, variable management, and full capabilities (72+ tools), use NPX Setup.
</Warning>

<Columns cols={2}>
  <Card title="NPX Setup (Recommended)" icon="bolt" href="/setup#-npx-setup-recommended">
    **Full capabilities — 72+ tools**
