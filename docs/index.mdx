...
<Note>
**New in v1.10.0** — Multi-instance support: run Figma Console MCP simultaneously across Claude Desktop, Cursor, Windsurf, and other AI clients. The server automatically selects an available port (9223–9232), and the Desktop Bridge Plugin connects to all active instances. **If upgrading:** update the package, re-import the plugin manifest in Figma, then run the plugin.
</Note>
