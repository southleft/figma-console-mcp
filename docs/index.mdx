...
<Note>
**New in v1.19.0 — High-Fidelity Design-to-Code:** Deep component trees with resolved design tokens, variant state machines with CSS pseudo-class mappings, and codebase-aware component scanning that prevents recreating existing components. 91+ tools total. [See what's new →](/figma-mcp-vs-figma-console-mcp)
</Note>
