...
- ✅ **All 114 tools** including design creation and real-time monitoring
...
- ✅ **All 114 tools** including design creation
...
- ✅ Full 114 tools including real-time monitoring
...
**Local Mode Transport:** The server automatically selects an available port in the range 9223–9232, supporting multiple simultaneous MCP instances. All 114 tools work through the WebSocket transport.
...
- **Local Mode (NPX/Git):** 114 tools — adds real-time monitoring (selection, changes, console)
