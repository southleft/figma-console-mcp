...
|------|-----------------|--------------|---------------|-----------|
| **Local Mode** (NPX or Git) | **106** | Yes | Yes | Yes |
| **Cloud Mode** (Remote + Relay) | **95** | Yes | No | No |
| **Remote Mode** (read-only) | **9** | No | No | No |

> **Bottom line:** Remote mode is read-only (9 tools). Cloud Mode adds write access (95 tools) without Node.js. Local has everything (106 tools) including real-time monitoring.

### Use NPX Setup (Recommended for Most Users)
- ✅ **All 106 tools** including design creation and real-time monitoring
...
- ✅ **All 106 tools** including design creation
...
- All 106 tools work through WebSocket
...
- ✅ Full 106 tools including real-time monitoring
...
**Local Mode Transport:** The server automatically selects an available port in the range 9223–9232, supporting multiple simultaneous MCP instances. All 106 tools work through the WebSocket transport.
...
- **Local Mode (NPX/Git):** 106 tools — adds real-time monitoring (selection, changes, console)
