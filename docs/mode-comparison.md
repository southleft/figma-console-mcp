...
|------|-----------------|--------------|---------------|-----------|
| **Local Mode** (NPX or Git) | **113** | Yes | Yes | Yes |
| **Cloud Mode** (Remote + Relay) | **101** | Yes | No | No |
| **Remote Mode** (read-only) | **9** | No | No | No |

> **Bottom line:** Remote mode is read-only (9 tools). Cloud Mode adds write access (101 tools) without Node.js. Local has everything (113 tools) including real-time monitoring.

### Use NPX Setup (Recommended for Most Users)
- ✅ **All 113 tools** including design creation and real-time monitoring
...
- ✅ **All 113 tools** including design creation
...
- All 113 tools work through WebSocket
...
- ✅ Full 113 tools including real-time monitoring
...
**Local Mode Transport:** The server automatically selects an available port in the range 9223–9232, supporting multiple simultaneous MCP instances. All 113 tools work through the WebSocket transport.
...
- **Local Mode (NPX/Git):** 113 tools — adds real-time monitoring (selection, changes, console)
