...
- Tool registration (113 tools in Local Mode, 9 in Remote Mode)
...
| Design Creation | `figma_execute`, `figma_create_component_set`, `figma_arrange_component_set` | WebSocket (Plugin) |
